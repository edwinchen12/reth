...
mod tests {
    ...
    #[tokio::test]
    async fn execution_checkpoint_matches() {
    ...
    #[tokio::test]
    async fn execution_checkpoint_precedes() {
        let factory = create_test_provider_factory().await;
    ...
    #[tokio::test]
    async fn execution_checkpoint_recalculate_full_previous_some() {
        let factory = create_test_provider_factory().await;
        let provider = factory.provider_rw().unwrap();
    ...
    #[tokio::test]
    async fn execution_checkpoint_recalculate_full_previous_none() {
        let factory = create_test_provider_factory().await;
        let provider = factory.provider_rw().unwrap();
